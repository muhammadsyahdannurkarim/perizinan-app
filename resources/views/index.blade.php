        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <h2 class="title">
                <a href="{{ url('/blog-details') }}">Dolorum optio tempore voluptas dignissimos</a>
              </h2>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <h2 class="title">
                <a href="{{ url('/blog-details') }}">Possimus soluta ut id suscipit ea ut in quo quia et soluta</a>
              </h2>
...
@section('navbar')
  ...
  <li><a href="#about">Tentang Aplikasi Perizinan</a></li>
  <li><a href="#services">Syarat Perizinan</a></li>
  <li><a href="#portfolio">Form Perizinan</a></li>
  <li><a href="{{ url('/blog') }}">Kelola Izin</a></li>
